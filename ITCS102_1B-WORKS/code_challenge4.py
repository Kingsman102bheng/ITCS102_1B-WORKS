print("Welcome to the world of manga readers ")
...
year = input("which year would you like to read?? (2000s / 2011s): ")

if manga == 'action':
    if year == '2000s':
        if length == 'short':
            print("This is what I recomend you (Death Note)")
        elif length == 'medium':
            print("This is what I recomend you (Bleach)")
        else:
            print("This is what I recomend you (One Piece)")
    if year == '2011s':
        if length == 'short':
            print("This is what I recomend you (Dororo)")
        elif length == 'medium':
